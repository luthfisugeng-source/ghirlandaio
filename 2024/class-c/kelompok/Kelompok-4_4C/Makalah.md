...
<p align="justify">
&nbsp;&nbsp;&nbsp;Vektor serangan dapat diklasifikasikan ke dalam tiga lapisan utama, yaitu hardware layer (fisik), software layer, dan human layer. Pada hardware layer (lapisan fisik), vektor serangan berkaitan dengan perangkat keras yang digunakan dalam operasional perpustakaan dan arsip digital. Ancaman ini dapat berupa kerusakan perangkat, pencurian perangkat penyimpanan data, atau gangguan terhadap infrastruktur jaringan dan server. Hal ini sejalan dengan penelitian yang menyatakan bahwa ancaman keamanan informasi “tidak hanya menyerang program atau aplikasi yang digunakan untuk mengelola informasi saja, namun juga fisik benda untuk menyimpan informasi tersebut” (Triandari, 2022) . Dalam konteks ini, serangan seperti Denial of Service (DoS) juga dapat dikaitkan karena dapat melumpuhkan layanan perpustakaan digital dengan cara membanjiri server menggunakan trafik yang sangat besar. Dampaknya, pengguna tidak dapat mengakses katalog online (OPAC), repository institusi, atau layanan peminjaman digital. Sebagai contoh, ketika server perpustakaan universitas diserang DDoS saat masa ujian, mahasiswa tidak dapat mengakses sumber referensi yang dibutuhkan.
<p align="justify">
&nbsp;&nbsp;&nbsp;Pada software layer (lapisan perangkat lunak), vektor serangan mencakup berbagai ancaman yang menargetkan sistem, aplikasi, dan jaringan digital. Contohnya adalah malware, hacking, serta eksploitasi celah sistem. Sebagaimana dinyatakan bahwa “malicious software, or malware, encompasses a broad category of threats designed to infiltrate and disrupt computer systems” (Rayhan, 2024) . Dalam praktiknya, malware dapat masuk ke sistem perpustakaan melalui file unduhan atau perangkat eksternal. Sebagai contoh, komputer pengelola repositori digital yang terinfeksi ransomware dapat mengalami penguncian akses terhadap seluruh koleksi, sehingga pustakawan tidak dapat mengakses maupun memulihkan data tanpa membayar tebusan.
<p align="justify">
&nbsp;&nbsp;&nbsp;Selain itu, vektor serangan berbasis manusia(human layer) seperti phishing dan social engineering juga sangat berbahaya dalam lingkungan perpustakaan dan arsip digital. Teknik ini memanfaatkan kelemahan pengguna,pustakawan, maupun arsiparis dengan cara menipu agar memberikan informasi sensitif, seperti kata sandi atau data akun. Misalnya, seorang pemustaka menerima email palsu yang mengatasnamakan sistem perpustakaan dan meminta untuk melakukan login ulang melalui tautan tertentu. Tanpa disadari, data akun yang dimasukkan justru dicuri oleh penyerang. Kondisi ini menunjukkan bahwa faktor manusia menjadi salah satu titik terlemah dalam keamanan siber, sehingga diperlukan peningkatan kesadaran dan literasi digital. Di samping itu, ancaman juga dapat berasal dari dalam organisasi itu sendiri, yang dikenal sebagai insider threat. Ancaman ini terjadi ketika individu yang memiliki akses resmi, seperti pustakawan atau staf IT, menyalahgunakan hak aksesnya, baik secara sengaja maupun karena kelalaian. Penelitian menunjukkan bahwa ancaman di perpustakaan digital dapat berupa pengaksesan informasi secara tidak sah, perubahan data, hingga penyalahgunaan sistem.
<p align="justify">
&nbsp;&nbsp;&nbsp;Lebih lanjut, akses ilegal atau hacking juga menjadi vektor yang signifikan, di mana pihak luar mencoba menembus sistem keamanan untuk mencuri atau merusak data. Misalnya, peretas dapat mengeksploitasi celah pada sistem repository yang tidak diperbarui, sehingga berhasil masuk dan menghapus atau memodifikasi koleksi digital. Selain itu, serangan melalui jaringan seperti man-in-the-middle memungkinkan penyerang menyadap komunikasi antara pengguna dan sistem perpustakaan maupun arsip, terutama jika menggunakan jaringan publik yang tidak aman. Seluruh vektor serangan tersebut pada akhirnya dapat mengganggu tiga aspek utama keamanan informasi, yaitu kerahasiaan (confidentiality), integritas (integrity), dan ketersediaan (availability). Oleh karena itu, perpustakaan atau arsip digital perlu menerapkan sistem keamanan yang komprehensif, baik dari sisi teknologi maupun sumber daya manusia, guna meminimalisir risiko serangan siber.
</p>
